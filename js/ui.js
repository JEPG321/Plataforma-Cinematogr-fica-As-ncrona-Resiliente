window.ui = (() => {
  ...
  function renderMovies(movies, favorites, lang, texts, onDetailsClick, onFavoriteClick) {
    grid.innerHTML = "";
  ...
  function renderGenreFilters(genreOptions, activeGenreKey, onFilterClick) {
  ...
  function renderLanguageButtons(currentLang, onLanguageChange) {
  ...
  function bindSearch(onSearchInput) {
    searchInput.oninput = (event) => {
      onSearchInput(event.target.value);
    };
  }

  function bindFavoritesToggle(onToggle) {
    favoritesToggle.onclick = onToggle;
  }

  function updateResultsText(count, onlyFavorites, texts) {
  ...
  function openModal(movie, lang, texts) {
