...
import { bindFavoritesToggle, bindSearch, openModal, renderGenreFilters, renderLanguageButtons, renderMovies, renderPromotion, renderReviews, renderServiceAlerts, updateFavoritesCount, updateFavoritesToggle, updateResultsText, updateStaticText } from "./ui.js";
...
function render() {
    ...
    renderMovies(visibleMovies, favorites, currentLang, texts, (movie) => openModal(movie, currentLang, texts), handleFavoriteClick);
    if (isFilteringGenre) {
